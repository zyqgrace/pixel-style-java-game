...
class ConfLoaderTest {
    ...
    void testReborn() {
        ...
        app.setup();
        app.delay(1000);
        Gremlin g = new Gremlin(20, 20, app.fm);
    ...
    void testWizardRightDirection() {
        ...
        assertEquals(20, app.player.getY());
        assertFalse(app.player.checkCollisionWall());
    }
